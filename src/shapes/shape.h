...
class Shape {
    public:
        ...
        glm::vec2 getRotationPivot() { return rotationPivot; }
        ...
        // rotation
        void setRotation(float degrees, float pivotX, float pivotY);
        void setRotationDegrees(float degrees);
        void setRotationPivot(float pivotX, float pivotY);
...
protected:
        ...
        // store the pivot in world coordinates
        vec2 rotationPivot = vec2(0.0f, 0.0f);
